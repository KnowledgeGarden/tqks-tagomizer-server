...
public class PivotSuite {
	 ...
	 * 
	 */
	public PivotSuite(HypViewerEnvironment env) {
		environment = env;
	...
	public IResult listPivotsByGroup(String groupId, int start, int count) {
		...
		try {
			 conn = provider.getConnection();
		     conn.setProxyRole(r);
		     x = this._listUsersByGroup(conn, r, groupId);
		     users = (List<String>)x.getResultObject();
		     x = this._listTagsByGroup(conn, r, groupId, start, count);
		     tags = (List<JSONObject>)x.getResultObject();
		     x = this._listResourcesByGroup(conn, r, groupId, start, count);
	...
	public IResult listPivotsByUser(String userId, int start, int count) {
		...
		try {
		     ...
		     documents = (List<JSONObject>)x.getResultObject();
		     x = this._listTagsByUser(conn, r, userId, start, count);
		     tags = (List<JSONObject>)x.getResultObject();
	...
	public IResult listPivotsByTag(String tagId, int start, int count) {
		...
		try {
			IResult x;
		     ...
		     groups = (List<JSONObject>)x.getResultObject();
		     x = this._listResourcesByTag(conn, r, tagId, start, count);
		     documents = (List<JSONObject>)x.getResultObject();
		     x = this._listUsersByTag(conn, r, tagId);
		     users = (List<String>)x.getResultObject();
		     pivots.put("groups", groups);
		     pivots.put("documents", documents);
		     pivots.put("users", users);
	...
	public IResult listPivotsByResource(String docId, int start, int count) {
		...
		try {
			IResult x;
			 conn = provider.getConnection();
		     conn.setProxyRole(r);
		     x = this._listGroupsByResource(conn, r, docId);
		     groups = (List<JSONObject>)x.getResultObject();
		     x = this._listTagsByResource(conn, r, docId, start, count);
		     tags = (List<JSONObject>)x.getResultObject();
	...
	public IResult listResourcesByTag(String tagId, int start, int count) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> documents;
		...
		try {
			IResult x;
		     ...
		     x = this._listResourcesByTag(conn, r, tagId, start, count);
		     documents = (List<JSONObject>)x.getResultObject();
		     result.setResultObject(documents);
		} catch (Exception e) {
			environment.logError(e.getMessage(), e);
			e.printStackTrace();
		} finally {
	 ...
	 * @throws Exception
	 */
	IResult _listResourcesByTag(IPostgresConnection conn, IResult r, String tagId, int start, int count) throws Exception {
		IResult result = new ResultPojo();
		List<JSONObject> l = new ArrayList<JSONObject>();
		result.setResultObject(l);
	...
	public IResult listResourcesByGroup(String groupId, int start, int count)  {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> documents;
	 ...
	 * @throws Exception
	 */
	public IResult _listResourcesByGroup(IPostgresConnection conn, IResult r, String groupId, int start, int count) throws Exception {
		IResult result = new ResultPojo();
		List<JSONObject> l = new ArrayList<JSONObject>();
		result.setResultObject(l);
	...
	public IResult listTagsByResource(String docId, int start, int count) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> tags;
	 ...
	 * @throws Exception
	 */
	IResult _listTagsByResource(IPostgresConnection conn, IResult r, String docId, int start, int count) throws Exception {
		IResult result = new ResultPojo();
		List<JSONObject> l = new ArrayList<JSONObject>();
		result.setResultObject(l);
	...
	public IResult listTagsByUser(String userId, int start, int count) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> tags;
	 ...
	 * @throws Exception
	 */
	IResult _listTagsByUser(IPostgresConnection conn, IResult r, String userId, int start, int count) throws Exception {
		IResult result = new ResultPojo();
		List<JSONObject> l = new ArrayList<JSONObject>();
		result.setResultObject(l);
	...
	public IResult listTagsByGroup(String groupId, int start, int count) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<String> users;
	 ...
	 * @throws Exception
	 */
	IResult _listTagsByGroup(IPostgresConnection conn, IResult r, String groupId, int start, int count) throws Exception {
		IResult result = new ResultPojo();
		List<JSONObject> l = new ArrayList<JSONObject>();
		result.setResultObject(l);
...
*/
	...
	//////////////////////////////
	public IResult listUsersByTag(String tagId) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<String> users;
	...
	IResult _listUsersByTag(IPostgresConnection conn, IResult r, String tagId) throws Exception {
		IResult result = new ResultPojo();
		List<String> l = new ArrayList<String>();
		result.setResultObject(l);
	...
	public IResult listUsersByResource(String docId) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<String> users;
	...
	IResult _listUsersByResource(IPostgresConnection conn, IResult r, String docId) throws Exception {
		IResult result = new ResultPojo();
		List<String> l = new ArrayList<String>();
		result.setResultObject(l);
	...
	public IResult listGroupsByTag(String tagId) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> groups;
	...
	public IResult listGroupsByResource(String docId) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> groups;
	...
	IResult _listGroupsByResource(IPostgresConnection conn, IResult r, String docId) throws Exception {
		IResult result = new ResultPojo();
		List<JSONObject> usrs = new ArrayList<JSONObject>();
		result.setResultObject(usrs);
	...
	public IResult listGroupsByUser(String userId) {
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<JSONObject> groups;
	...
	public IResult listUsersByGroup(String groupId) { 
		IResult result = new ResultPojo();
		IPostgresConnection conn = null;
		IResult r = new ResultPojo();
		List<String> users;
	...
	IResult _listUsersByGroup(IPostgresConnection conn, IResult r, String groupId) throws Exception {
		IResult result = new ResultPojo();
